const STATIC_ASSETS = [
  '/event-logger/',
  '/event-logger/index.html',
  '/event-logger/offline.html',
  '/event-logger/icon_192x192_new_subject.png',
  '/event-logger/icon_192x192.png',
  '/event-logger/icon_512x512.png',
  '/event-logger/logpack.svg',
  '/event-logger/manifest.json',
  '/event-logger/screen_shot1.png',
  '/event-logger/screen_shot2.png',
  ...
  '/event-logger/edit-subject/index.html',
  '/event-logger/event/index.html',
  '/event-logger/event/edit/index.html',
  '/event-logger/event/new/index.html',
  '/event-logger/help/index.html',
  '/event-logger/new-subject/index.html',
];
